...
var serviceLookupHandler = (function() {
  ...
  deps.serviceLookup = function(serviceName, routePath) {
    var serviceHealthUrl = 'http://' + CONSUL_ADDRESS + '/v1/health/service/' + serviceName + '?passing'; // jshint ignore:line
    ...
    return got
      ...
      .catch(error => {
        console.error("Could not look up service dependency. Critical error!!!! " + error);
        process.exit(1);
      })
  }
